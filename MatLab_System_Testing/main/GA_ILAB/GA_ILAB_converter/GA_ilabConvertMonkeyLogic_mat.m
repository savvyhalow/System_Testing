...
for i=1:length(import.BHV.TrialNumber)       
    marktimes = import.BHV.CodeTimes{i} ./ import.BHV.AnalogInputFrequency;
    marktimes = marktimes - marktimes(find(import.BHV.CodeNumbers{i}==9,1,'first')) + marktime_start;
    marktimes = marktimes(import.BHV.CodeNumbers{i}~=9 & import.BHV.CodeNumbers{i}~=18);
    ...
    dattimes =  (marktime_start - 1 + (1:length(import.BHV.AnalogData{1,i}.EyeSignal))' ./ import.BHV.AnalogInputFrequency);
    marktime_start = marktime_start + (1 + length(import.BHV.AnalogData{1,i}.EyeSignal)) / import.BHV.AnalogInputFrequency;
