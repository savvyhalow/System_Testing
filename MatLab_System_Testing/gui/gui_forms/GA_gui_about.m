function varargout = GA_gui_about(varargin)
...
% Last Modified by GUIDE v2.5 16-May-2010 11:09:34
...
% --- Otherwise, executes on mouse press in 5 pixel border or over txt_version.
function txt_version_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to txt_version (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pb_hyperlink.
function pb_hyperlink_Callback(hObject, eventdata, handles)
% hObject    handle to pb_hyperlink (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

web('www.gazealyze.sourceforge.net','-browser');
